---
saved_at: "2026-02-18T14:26:02.108Z"
source_url: "https://x.com/thedankoe/status/2023779299367809063?s=12"
source_app: "ios-share-extension"
page_title: "Human 3.0 – A Map To Reach The Top 1%"
note: ""
...
多次元的に鍛え上げられたい。すべてのステータスを最大にしたい。NPCにはなりたくない。レベル100のプレイヤーになりたい。マップのすべてのエリアをアンロックして。身体、知性、職業をすべてマックスにして。金庫には黄金があふれるほど。すべてやり遂げたい。心、体、精神、人間関係、お金。

> This desire has drastically influenced my life.

この欲求は私の人生に大きな影響を与えてきた。
...
十代の頃はフィットネスに夢中になった。次に、できるだけ多くの知識を吸収したいと思った。そして自由になりたいと思い、様々なビジネスモデルに挑戦して失敗を繰り返し、ついに一つを成功させた。様々なスピリチュアルと哲学的な時期を経て、それが「お金」や「フィットネス」といった「表面的な追求」を、平均的な人とはまったく異なる視点で見られるようになる助けになったと思っている。
...
過去15年間、心理学、自己啓発、哲学、社会力学、テクノロジー、インターネット、スタートアップ、お金、宗教、意味の深部を研究してきた。
...
過去6年間、自分の発見についてオンラインで書いてきた後、今日の世界のための新しい哲学を形成し始めている重要な重複パターンに気づいた。私個人の哲学ではあるが、共感する人もいるかもしれない。
...
私が学んできたすべてを、現代の風景をナビゲートするための一つの包括的な地図に統合したい。凡庸から脱出し、最高の潜在能力を実現するための知識、スキル、原則を提供したい。できる限り非教条的で科学的根拠のあるものにしようとするが、明確さと確信を持って要点を伝えたい。忘れられた教科書にならないよう、明確で自然な言語を使いながら、できる限り概念を簡素化してこれを書く予定だ。そのため、私らしい話し方をして、ニュアンスはあなたに委ねる。ニュアンスと批判的思考は常に読者にある。
...
その多くは間違っているだろう。私の言うことに疑問を持つことを勧める。実際、これを私と一緒に発展させてほしい。あなたの文章やコンテンツで HUMAN 3.0 について話すなら、ぜひ見せてほしい。これらのアイデアを受け取り、発展させてほしい。H3.0モデルが気に入ったなら、使ってほしい。

> Now, there are plenty of incredible models already out there.

さて、すでに多くの素晴らしいモデルが存在する。
...
スパイラル・ダイナミクス（心理学）、仏教とキリスト教（意味）、唯物論とメンタリズム（現実の本質）、eコマースとコンサルティング（ビジネス）、レッドピルとフェミニズム（社会力学）など。どこを見ても、すべての問題の答えを約束する数百のモデルが見つかる。
...
すべてに真理があるが、重大な欠陥は、それらがしばしば人生の一つのドメインまたは視点に孤立していることだ。知識が無限に入れ子になったウェブであるにもかかわらず、私たちは数学、英語、科学を単独のサイロ化されたクラスとして学ぶ。私たちは実験室でカエルを解剖し、それらが由来するエコシステム全体と相互連関する関係を考慮せずに結論を出す。さらに、一部の人には飲み込みにくいことだが、多くのスピリチュアルな教師は虚弱な体を持っている。多くのビジネスマンは人間関係を維持できない。多くの「アルファ男性」は感情的に整合していない。これらはそれぞれ素晴らしい成就だが、真に自己発達している人は稀だ。
...
たとえこれらのモデルやグルが、古代ギリシャ哲学のように複数のドメインを結びつけていても、インターネット、テクノロジー、AIがすべてを変え始める前に広まったものが多い。より重要な点として、仕事やお金などの分野に触れているものはごく少なく、それは意外だ。なぜなら、それらがほとんどの人の心と生活を支配しているからだ。

> Today, we will lay the foundation of HUMAN 3.0.

今日、我々は HUMAN 3.0 の基盤を築く。
...
これから数ヶ月（もしかすると数年）かけて、人生を最大限に生きることが本当に何を意味するのかを明らかにしていく。このモデルが含むすべての詳細をこのイントロで網羅することはできない。
...
注：モデルのニュアンス、文明への影響、歴史的文脈、科学的基盤、そして私の個人的な原則を織り込んだ HUMAN 3.0 ナレッジベースを作成した。モデル全体の包括的でざっと読める解説を見たい場合は、こちらで読むか、AIに貼り付けて探索してほしい。最後にもリンクを貼る（まずこれを読むことをお勧めする）。

> HUMAN 3.0 – A Model To Maximize Your Potential

HUMAN 3.0 – あなたの潜在能力を最大化するモデル
...
自分の発展をマッピングし、メタタイプを見つけ、人生で解決すべき次のコアな問題を特定するためのAIプロンプトを作成した。以下にもリンクを貼る。まずこの記事を読んで内容を理解することをお勧めする。
...
このモデルは全体像を提供する。これは教条的な実行可能なステップのセットではなく、最大の潜在能力に到達し、精神的、身体的、スピリチュアル的、職業的なプラトーをより速く突破するためのガイドラインのセットだ。人類の発展全体に見られるパターンを方向付け、すでに多くの重労働をこなした様々な科学的、心理学的、スピリチュアル的、職業的モデルの上に構築されている。

> My goal is to take the best parts of the world's greatest theories and apply them to the life of the individual.

私の目標は、世界の最も偉大な理論の最良の部分を取り、それを個人の生活に適用することだ。
...
このモデルを理解すると、各象限内における現在の発展レベル（あなたのアーキタイプ）と全体的な発展の姿（あなたのメタタイプ）をマッピングし始めることができる。そして、人生のすべての領域を最大化した3.0+レベルのメタタイプに向けてさらに進む試みができる。

> We will discuss those later in this letter, but for now, let's understand the foundation.

それらについては後ほど論じるが、今はまず基盤を理解しよう。
...
体（個人的な物理世界）——あなたの行動と外見。世界があなたをどう解釈するか。栄養、トレーニング、趣味、習慣、身だしなみ、コミュニケーション、服装などを含む。
...
精神（集合的な精神世界）——環境、コミュニティ、文化、家族、友人、同僚、そして現実との関係。どのように意味とつながりを引き出すか。
...
職業（集合的な物理世界）——教育、キャリア、経済などのシステム、構造、社会的機関との関係。どのように社会に適合し、貢献するか。
...
ケン・ウィルバーのAQALモデルから適応したこの象限は、四つの基本的な視点を表し、すべての知識と経験の一般化されたマップを作り出す。
...
この現実のマップは部分的な思考を防ぎ、問題を一つの視点に還元しない。内的な精神的問題は、新しい仕事を得るような職業的手段で最もうまく解決できないかもしれない。スピリチュアルな問題は、栄養のような身体的手段で最もうまく解決できないかもしれない。資本主義者とキリスト教徒はそれぞれのドメインで発達しているが、そのモデルを他のドメインの問題に適用しようとすると不必要な痛みを経験する。お金はしばしば意味のために解決せず、その逆も然りだが、それらが密接に結びついていないという意味ではない。これらのドメインはすべて重なり合っており、上記のすべてで自己を発展させることで、自分の未来をコントロールできる生活を生き始める。人生、発展、進化は、より多くの混乱や複雑性に向けた一般的な展開に従い、その混乱を含むために秩序ある構造が作られるので、人生のプロセス、特にあなたの個人的な人生を「問題解決」と呼ぶことができる。
...
種は花になるまで展開する。花は種よりもはるかに複雑で、その状態に到達するために、自己発展するための環境からの資源が必要だ。種は成長するという自然な欲求を持ち、多くの進化の過程を通じて、多くの他の植物の種が絶滅する原因となった問題を解決してきた。
...
種が意識的に成長したり問題を解決しようとしているとは思わないかもしれない。それでも、観察とそのパターンを個人の生活に結びつけることで、私たちは言語を作り出したため、それをそう呼ぶだろう。人生には、より大きな複雑性に向けた自然な流れがあることを理解し始めることができる。複雑性は問題を導入し、複雑性から生じるエントロピーを制約するために、創造を通じて秩序ある構造が出現しなければならない。
...
あなた自身の個人的な進化において、潜在能力に到達したいという欲求がある → 未知の領域に一歩踏み出し、複雑性に出会う → 前進を妨げる問題を解決するための知識とスキルを身につける（または停滞して混乱に飲み込まれる） → アイデンティティが拡大し、新しいレベルに上昇する → 行き詰まらない限り、このプロセスが繰り返される。
...
このパターンは現実のすべての面とドメインで気づくことができる。より多くの例を考えることを勧めるが、簡潔さのために次に進もう。
...
各象限内には、低意識（1.0）、中意識（2.0）、高意識（3.0）を表す3つのマクロ発展レベルがある。
...
これらのレベルは、スパイラル・ダイナミクスや自我発達の9段階など、発達心理学における様々なモデルから適応されており、これらはすでに多くの心理学的理論のよく研究されたオーバーレイだ。要するに、これらは私たちの心（思考と意思決定に影響する価値観、信念、世界観）が時間をかけて予測可能な段階を経て進化することを示してきた。
...
Human 1.0（順応者）——確立された権威と伝統を重視する。狭量さ、白黒思考、「唯一の正しい方法」があると信じることで特徴づけられ、それはしばしば幼少期の条件付けに由来する。
...
Human 2.0（個人主義者）——規範を拒絶し、自分の目標を追求する。地位を獲得し、価値があると認識されたいという欲求を持つ。より狭量でなくなるが、今度は自分の方法が唯一の正しい方法だと信じる。
...
Human 3.0（統合者）——複数の視点を採用し、様々な現実のパターンを結びつけ、新しいパスを戦略立てることができる。すべての視点が、より全体的で相互に有益な結果のために統合できる真実を持つことを理解している。狭量さなど、一部の人がレベル1の特性と認識するものを示すことがあるが、それはノイズを遮断するための意図的な選択だ。
...
スパイラル・ダイナミクスのようなモデルでは、「スパイラル」は個人が発展を通じて自己と他者の間でどのように焦点を移すかを説明する（宗教のコミュニティを拒絶して個人的な無神論を受け入れるなど）。Human 3.0では、これは特定の象限で新しいレベルに到達したときに起こる。誰かが心において個人主義者になり、それがスピリットへの焦点の移行を引き起こす可能性がある。そこではまだ順応者の段階にあり、権威に従う。
...
各レベルの説明は各象限で異なる形を取る。例えば、職業象限（右下）における3.0統合者は自分の人生の仕事を追求するためにAIを効果的に活用できるが、1.0順応者は知識、スキル、経験の不足によりAIは純粋に悪だと信じる。
...
体象限（右上）では、低意識の個人は自分の体に入れる栄養に理解がなく、より良い決断を下すための特性を習得していないため、肥満と怠惰につながる。一方、高意識の個人は様々な栄養素が体とどのように相互作用するかを理解し、目標を達成するために食事を微調整できる。
...
これらのレベルは、任意のドメインにおける自己の複雑性を反映している。Human 3.0グラフ全体があなたを表す。あなたがより複雑になるほど（視点を育み、意識を拡大することで）、人生はより面白くなる。なぜなら、取り組みたい課題を選べるからだ。ビデオゲームのように：レベル1はスクリプトで動くNPCや非プレイヤーキャラクターに似ており、レベル2は自分のストーリーラインを選ぶメインキャラクター、レベル3は他の人も楽しめる新しいゲームを作ることができるプログラマーだ。注：低いまたは高いレベルは「悪い」または「良い」ではなく、個人の旅の地点だ。「高意識」の人はより良いのではなく、より発達しているだけであり、その発達には明らかな利点がある。どのレベルも去ることはない。その前のレベルを超越して含む。下位段階で習得した知識、スキル、ツールを活用できるより大きな視点を獲得する。
...
楽しんでいるなら、アルゴリズムが表示しない場合に備えて、これらの記事を直接受け取りたい場合はこちらに参加してほしい。
...
各レベル内には、次のレベルに到達するために通過しなければならない3つの発展フェーズがある。フェーズはレベルアップまたは後退を意味する垂直的な発展を表す。

> There are 3 general patterns that we can observe when an individual goes through a profound change:

個人が深遠な変化を経るときに観察できる3つの一般的なパターンがある：
...
不協和音（フェーズ1）——個人が現在の人生の段階を「味わい」、狭量さと安定感で麻痺しなければ、現在の状況に疲れを感じるが、次にどんな人生が来るのか不確かになる。
...
不確実性（フェーズ2）——その個人が嫌悪感に十分気づくならば、未知の領域への不確実な一歩を踏み出し、新しい知識とスキルに自分を開く。
...
発見（フェーズ3）——地図をナビゲートするように、次の発展レベルに到達するための教育、ツール、資源、洞察を発見する。
...
用語のために、特定のドメイン内でのレベルにフェーズを追加することで、人生の特定の領域をマッピングできる。
...
例として、「職業2.1」（レベル2、フェーズ1）は、集合的な外部意識（システム、構造、社会的機関との関係）の発展を表す。「2」は個人主義者レベルを表し、「.1」はほぼそのステージを使い果たし、次の章に何があるかを発見するためにレベル3への不確実な一歩を踏み出さなければならないことを表す。職業象限では、これは新しいキャリアを追求したが、間違ったはしごを登っていたことに気づき、自分の天職を発見するための転換が必要であることを意味するかもしれない。
...
個人はこのプロセスで簡単に偽の変容を経験することがある。各フェーズを通じて新しいレベルに到達したと感じるかもしれないが、必要な特性発展なしにそのレベルの発展がどのように見えるかを単に模倣しているだけだ。これは自己欺瞞であり、現在のレベルに存在する残りの問題を解決するまで、人々を現在の段階に閉じ込め、さらに進むことを妨げる。この偽の変容は、あるドメイン（心のドメインなど）で自己を発展させ、別のドメイン（精神や職業のドメインなど）で進歩したと思い込むときに起こる可能性がある。個人はまた、一時的なストレスの期間中や、現在のレベルを超えた問題が人生に入ってきたときに、低いレベルに後退することもある。これは、「物事が良く感じられた」時代を振り返り、その感覚を現在に取り戻したいと切望する理由を説明している。
...
フロー心理学やニーチェなど多くの哲学者の思索が示すように、楽しい人生は抵抗を克服することでこれらのフェーズを進むことにある。深い変化はほとんど偶然に起こらない。気を散らすものと安定感の性質によって後退することなく、ビジョン、目標、優先事項について意図的であるとき、これらのフェーズで多くの人を飲み込む混乱は耐えられるものになり、しばしばあなたが心の奥に大切にする人生の最も充実した部分になる。
...
レベル3以降では、個人はより複雑な課題を追求し、ゲームへの愛のためにこれらのフェーズをシミュレートできる（会社を売却し、落ち込み、より啓発された視点から別の会社を始めるCEOのように）。彼らがゲームを作るので、それは無限になる。
...
各フェーズ内には、次のレベルが現れる前に習得しなければならない知識、経験、スキルの閾値がある。フェーズが垂直的な発展を表す一方、特性は水平的な発展、または次のフェーズに到達するのに十分なものを発見するまで未知の領域をナビゲートすることを表す。
...
各象限、レベル、フェーズは、一定レベルのスキルを必要とする異なる課題を提示する。そのスキルには実験と教育が必要だ。
...
フィットネスに精通していても、実践と経験なしには、太ったパーソナルトレーナーのアーキタイプになる。その知識は称賛に値するが、真剣に受け止める人は少ない。それにはメリットとデメリットがある。
...
垂直（フェーズ）と水平（特性）の発展の両方における罠は、退屈と不安だ。スキルと経験なしに新しい発展レベルにジャンプしようとすると、不安になって失敗する。まったくレベルアップを試みなければ、退屈になり、安定感と気晴らしに頼るようになる。
...
退屈と不安の両方が心の混乱を引き起こし、進化の展開する流れからあなたを引き離す。人生は大丈夫に見えるかもしれないが、すべてが鈍くて無意味に感じられる。

> That leads us into Channels – a way to combat disorder and make substantial progress.

それは「チャンネル」につながる——混乱と戦い、実質的な進歩を遂げる方法だ。
...
任意のレベルの不協和音フェーズに到達すると、「チャンネル」を活用する能力を得る。
...
チャンネルをビデオゲームのエキサイティングなクエストと考えよう。知識やスキルのウサギの穴。あるトピックの調査やプロジェクトの作業を止められず、時間が驚くほど早く過ぎるとき。
...
Human 3.0グラフでは、チャンネルの一端が知識特性にあり、もう一端がスキル特性にあることがわかる。通常、人は学習または構築に「執着」し、それが特定の象限内で次の発展レベルに向けて急速に進むための経験の急速な獲得をもたらす。
...
心——深い瞑想状態に没頭する（スキル）、または夜眠れないほど思考の流れを追い、脳を明るくするアイデアの多数をもたらす（知識）。
...
体——新しいダイエット、サプリメント、または方法論を見つけ、それについてできるすべてのコンテンツを一気に視聴する（知識）。3ヶ月間ランニングまたはウェイトリフティングに執着し、これまでで最大の成果を上げる（スキル）。
...
精神——神秘的な経験。ハネムーン期。親密な瞬間。人生の現在のフェーズに「ピッタリ合う」哲学を見つける。などなど。
...
職業——最大の明確さに達し、それが刺激的なキャリア変更、製品発売、または創造的な期間に素早くつながる（スキル）。完璧な機会を見つけ、ビジネスを始めるために必要なスキルを学ぶことを止められない（知識）。
...
まず、現在のレベルに完全に慣れた後、不協和音フェーズに到達しなければならない。現在の状況に疲れを感じ、問題に麻痺しなければ、嫌悪感を燃料として未知の領域に押し進む。特定の象限（体など）内で目標やビジョンや目的を作る。知識とスキルを習得し始める。学び、行動する。失敗し、目標を洗練させる。引き込まれるチャンネルを見つけるまで十分に実験する。
...
誰かがチャンネルにいることは、それについて話すときの興奮度でわかる。言葉が止まらなくなった地点に達した本の執筆者のように。彼らにはビジョンがある。スキルと知識が、前進する明確さの感覚を提供する。
...
不協和音フェーズにいるとき、私ができる最善のアドバイスは、興奮と熱意を探し、恥なくそれを追求することだ。その恥は低いレベルの心を示しており、そのプロセスで自信のスキルを発展させることができる。
...
チャンネルに強制的に入るか、発展の高原を突破するための特定の戦術があり、これを「グリッチ」と呼ぶ——マトリックスのグリッチのように、もしマトリックスがレベル1と2の境界であり、レベル3で自分のものを作るまでそうであるなら。サイケデリクスは誰かを神秘的な体験に強制することができる。PEDはフィットネスの進歩を加速できる。自分が払えないアパートに引っ越すことは、副業を機能させるまで学び行動することを強制する本物の締め切りを提供できる。AIは最近で最も広く利用可能なグリッチであり、すべてのドメインを横断する。自己発展または急速な自己破壊に使える。センスと識別力が必要だ。AIは限られた視点からのみ純粋に良いまたは純粋に悪だ。これらには注意が必要で、進歩を加速させる一方、低意識レベルではリスクが高まる。変性状態を解釈する事前経験なしにサイケデリクスを摂取すると、正気を失うかもしれない。AI精神病と心をAIに外注することはより普及してきており、AIが悪いからではなく、ステロイドを摂取するようなものだからだ。基盤を構築し、栄養のすべてのドメインを広範に研究し、すべての潜在的な相互作用を理解し、5年以上トレーニングしていない場合（比喩的に）、AIには不快な副作用がある。それでも、どれだけ注意深くても、現実の多くの高報酬メカニズムにはコストが伴う。特定の目標を持つ特定の人々にとって、結果にもかかわらずそのリスクを取ることを意識的に決断することができる。ほとんどの人、特にレベル1の人にとって、それらは死刑宣告だ。「自然な」潜在能力を最大化して十分な経験を持ち、一撃でやられないようにしよう。知識とスキルはリスクを減らす。
...
迷子に感じるなら、おそらく不協和音フェーズにいる。それを乗り越えれば、次のチャンネルを見つけ、人生に再び恋をすることができる。
...
メタタイプを特定し、すべての象限にわたる発展をマッピングし、人生のコアな問題を見つけるためのプロンプトをこちらで作成した。
...
上記の例では、各象限内に3つのアーキタイプしか示していない。それよりはるかに多くあるため、これらは固定されていないことを理解してほしい。これは単に楽しんでいるだけだ。
...
ある人が象限内で自己を発展させるにつれて、低意識から高意識への一般的な進行があることに気づくだろう：
...
心象限における NPC → プレイヤー → クリエイター は、生まれながらに割り当てられたスクリプトで生きることをやめ、自分のゲームをプレイし始め、そして他の人も楽しめる新しいゲームを作る人を表す（「構成レベル」の意識に似ている）。
...
体象限における インセル → チャド → シグマまたはベータ男性 → アルファ男性 → シグマ男性 は、今日の世界で見られる一般的なアーキタイプで、行動と外見で観察できる。これはグラフの他のエリアに対応していたり、同じ象限内にさらなる原因があったりする。例えば、インセルは通常食事と環境による高いエストロゲンレベルを持ち、職業象限の社会構造が加工食品やマイクロプラスチックを引き起こし、大規模にその問題をさらに悪化させる。
...
仕事 → キャリア → 天職 は職業象限の多くの進行の一つだ。仕事に関しては、今日では何でも始まる可能性がある。仕事を持たない人もいれば、早い段階で天職に入る人もいる。各レベルを通じた進行についての重要な洞察は、低意識（順応者）から始まり、高意識（統合者）に進歩する能力を持つということだ。
...
精神象限における 宗教 → 無神論 → 神秘主義 は、厳格な宗教的家庭で育った人々に見られる一般的なパターン（唯一のパターンではない）で、反抗につながる。そして彼らは神についての新しい視点を再発見し、レベル1に含まれていた真実に戻る。
...
ケン・ウィルバーの「プレ・トランス誤謬」は、両方が従来の合理的（個人主義者）視点から「非合理」に見えるため、人々が前合理的（順応者）状態を超合理的（統合者）状態と混同するときに起こる。これは両方向で起こる可能性がある。レベル1の原始的状態をレベル3の地位に高めることができ、一部の人は本物のレベル3の発展を原始的思考に還元することが多い。言い換えると、幼少期の条件付けを超えた知識と経験が不足している「聖書ゴリラ」は神秘家を真剣に受け止めるのが難しいが、神秘家はしばしば同じ真実を、しかしより包括的な視点から持っている。役立つなら、IQベル曲線のミームを思い浮かべよう。
...
もちろん、これは精神象限での発展的進行がどのように展開するかの一つの小さな例に過ぎない。個人的な関係、スポーツ、家族、科学的または形而上学的信念など、様々なパターンがある。

> There are dozens to hundreds of archetypes within each quadrant, not just the three I displayed in each.

各象限には、私が各象限に表示した3つだけでなく、数十から数百のアーキタイプがある。
...
では、上記の例で、各象限、レベル、フェーズ、特性内の発展点をプロットすると、特定の個人がどこに位置するかの包括的な理解が得られる。（地図上の不透明な白い形でこれを見ることができる。）

> This specific example of a person would be at Human 2.0.

この特定の人物の例は Human 2.0 に位置する。
...
各象限に3つ以上のアーキタイプをマッピングするなら、はるかに複雑で包括的になるが、それは将来の手紙のために取っておく。
...
これらの説明を取り、一つに統合すると、メタタイプが得られる。私はこのためにAIを使う予定だ。なぜなら、16の一般化されたボックスの一つに置く静的な「性格テスト」にしたくないからだ。
...
この場合、この人物のメタタイプは「アウトライダー」と考えることができる。要するに、これは反抗なしに主流のパターンから離れ、カウンターカルチャーのレンズから活動している人物だ。外見には気を配らないが、体象限での経験が不足しているため、これは偽の変容かもしれない。
...
職業があまりにも多くの時間を消費して心が悩み、体のためのエネルギーがなく、精神を楽しませることができない場合、それはチャンネルのチャンスを作り、知識とスキルの習得を通じて解決しようとしなければならない明らかな問題だ。この場合、毎日1時間ビジネスの機会を研究し、練習のための時間を作ることができる。他の人より時間がかかるかもしれないが、フェーズを進み始めると、時間を占有している現在の仕事を減らすか完全に排除できるとより確信を持つようになる。
...
その転換は別の問題をより明白にするかもしれない。例えば、エネルギー不足や潜在的なクライアントや顧客からの尊重不足など。ビジネスの次のレベルに達するために、ビジネスでのさらなる発展が必要なのではなく、体、心、または精神に関連する問題を解決することが必要かもしれない。それでも、素晴らしいビジネスを構築し、世界のすべてのお金を持っていても、職業的な追求における意味の欠如から胸の中央に穴が開くことがある。
...
問題解決の単純な性質によって（そしてそれらに気づくことを妨げる気晴らしに対して警戒を怠らないことで）、仕事が遊びになり、健康がデフォルト状態になり、意味が豊富で、心が味方になるライフスタイルを作る。
...
アルゴリズムが配信しない場合に備えて、これらの記事を直接受け取りたい場合はこちらに参加してほしい。
